...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_TXD_PIN, 29);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_RXD_PIN, 28);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_RTS_PIN, 27);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_CTS_PIN, 26);
